...
engine = create_engine('sqlite:////Users/christbr1985/Dropbox/CongressMonitor/StateGovTracker.db') # Change to location of database
...
class offices(Base):
    __table__ = Table('official_offices', Base.metadata, autoload=True, autoload_with=engine)
