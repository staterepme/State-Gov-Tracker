...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/christopher/Dropbox/CongressMonitor/StateGovTracker.db',                      # Or path to database file if using sqlite3. was /home/christopher/Dropbox/CongressMonitor/StateGovTracker.db, you need to put your own path here.
